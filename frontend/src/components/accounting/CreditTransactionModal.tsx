          ...
          <Stack spacing={3}>
            ...
            <Box>
              <TextField
                ...
                helperText={errors.particulars || 'Describe what this credit transaction is for (required)'}
                placeholder="e.g., Payment received from customer, Loan received, Sales revenue"
                InputProps={{
                  style: { fontSize: '1rem' }
                }}
                InputLabelProps={{
